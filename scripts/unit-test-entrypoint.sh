#!/bin/bash
cd /var/lib/eventkit
source /var/lib/.virtualenvs/eventkit/bin/activate
...
/var/lib/.virtualenvs/eventkit/bin/python /var/lib/eventkit/manage.py collectstatic --noinput
/var/lib/.virtualenvs/eventkit/bin/python /var/lib/eventkit/manage.py makemigrations
/var/lib/.virtualenvs/eventkit/bin/python /var/lib/eventkit/manage.py migrate
/var/lib/.virtualenvs/eventkit/bin/python /var/lib/eventkit/manage.py loaddata /var/lib/eventkit/eventkit_cloud/fixtures/admin_user.json
